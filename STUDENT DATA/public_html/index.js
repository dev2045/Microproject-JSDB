...
var token = "90933170|-31949319314137146|90951010";
...
function validateData() {
      ...
      function getStu() {
        ...
        var getRequest = createGET_BY_KEYRequest(token,schoolDB,studentREL,stuIdJsonObj);
    ...
    function changeData() {
        ...
        var updateRequest = createUPDATERecordRequest(token,jsonChg,schoolDB,studentREL,localStorage.getItem("recno"));
        jQuery.ajaxSetup({async: false});
